...
async function scrapeGpt3(messages) {
    try {
        const response = await axios_1.default.post("https://chatbot-ji1z.onrender.com/chatbot-ji1z", { messages }, {
            timeout: 30000,
            headers: {
        ...
        return JSON.parse(JSON.stringify(response.data.choices[0].message.content, null, 2));
    }
    catch (error) {
