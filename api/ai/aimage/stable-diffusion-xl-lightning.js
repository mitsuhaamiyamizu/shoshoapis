...
async function stable(prompt) {
    try {
        const response = await axios_1.default.post(CloudflareAi() + "/image-generation", {
        ...
        const base64Image = buffer_1.Buffer.from(response.data, "binary").toString("base64");
        return base64Image;
    }
    catch (error) {
