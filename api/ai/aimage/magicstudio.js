...
async function scrape(prompt) {
    ...
    form.append("anonymous_user_id", crypto_1.default.randomUUID());
    ...
    try {
        const response = await axios_1.default.post("https://ai-api.magicstudio.com/api/ai-art-generator", form, {
            headers: {
                ...form.getHeaders(),
