...
async function scrape(query) {
    try {
        const responseSearch = await axios_1.default.post("https://www.muslimai.io/api/search", { query: query }, {
            headers: {
        ...
        const responseAnswer = await axios_1.default.post("https://www.muslimai.io/api/answer", { prompt: prompt }, {
            headers: {
                "Content-Type": "application/json",
                "User-Agent": "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Mobile Safari/537.36",
                "Referer": "https://www.muslimai.io/",
