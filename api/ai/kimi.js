...
class KimiScraper {
    ...
    token = "eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9..Ib8Lsmcdaela6fRspLeYRjr5P6JzZtCer10FD2uroDrC-4BUShPvdb5qKgPQo4XZFjunNJYSnzh-C9kcmZ3i_g";
    deviceId;
    axiosInstance;
    constructor() {
    ...
    generateDeviceId() {
        return crypto_1.default.randomBytes(8).readBigUInt64BE(0).toString();
    }
    async createChatSession(sessionName = "未命名会话") {
        try {
    ...
    async sendMessage(chatId, message, useSearch = true) {
    ...
    async chat(message, sessionName) {
        try {
